...
function Counter({ target, suffix = "" }) {
  ...
  return (
    <span ref={ref}>
      {typeof target === "number" ? display : display}{typeof target === "number" ? suffix : ""}
    </span>
  );
}
  ...
  return (
    ...
    >
      <p style={{
        ...
        {isNumber ? <Counter target={value} suffix={suffix} /> : value}
      </p>
      <p style={{
...
function ResponsibilityGroup({ title, items, groupIndex, parentInView }) {
  return (
    <div>
      <motion.p
        initial={{ opacity: 0 }}
  ...
  return (
    <div ref={cardRef} style={{ display: "flex", gap: "32px", alignItems: "flex-start" }}>
      ...
      <div style={{ flex: 1, minWidth: 0, paddingBottom: isLast ? 0 : "56px" }}>
        ...
        >
          <p style={{
            fontSize: "12px", color: "#3F6B57", margin: "0 0 6px",
            fontWeight: 600, letterSpacing: "0.05em",
          }}>
            {exp.period}
          </p>
          <h3 style={{
            fontSize: "22px", fontWeight: 600, color: "#1D1D1D",
        ...
        <div style={{
          display: "grid",
          gridTemplateColumns: `repeat(${Math.min(exp.stats.length, 4)}, 1fr)`,
          gap: "20px 16px",
          marginBottom: "32px",
        }}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "24px", flexWrap: "wrap" }}>
          ...
          {exp.caseStudy && (
            <motion.button
              ...
              onMouseEnter={e => e.currentTarget.style.background = "#3F6B57"}
...
export default function Experience() {
  ...
  const trackHeight = experiences.length * 320;
        ...
        <div style={{ position: "sticky", top: "100px" }}>
          <motion.p
            ...
            style={{
              ...
              color: "#3F6B57", fontWeight: 600, margin: "0 0 18px",
            }}
          >
            Experience
          </motion.p>
          ...
          <motion.h2
            ...
            style={{
              fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 600, color: "#1D1D1D",
          ...
          <motion.p
            ...
            style={{
              fontSize: "12px", color: "#AAA", margin: "32px 0 0",
